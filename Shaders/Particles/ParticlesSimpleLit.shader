...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
        //  GBuffer pass.
        Pass
        {
            ...
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/Particles/ParticlesSimpleLitGBufferPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
        ...
        Pass
        {
            ...
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/Particles/ParticlesEditorPass.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/UnlitInput.hlsl"
