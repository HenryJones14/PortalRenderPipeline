Shader "Universal Render Pipeline/Baked Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/BakedLitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/BakedLitInput.hlsl"
            #include "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/BakedLitMetaPass.hlsl"
