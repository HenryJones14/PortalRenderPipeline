...
#region Includes
        ...
        {
            const string k2DLightingUtil = "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/2D/Include/LightingUtility.hlsl";
            const string k2DNormal = "Packages/com.gameboxinteractive.portal-render-pipeline/Shaders/2D/Include/NormalsRenderingShared.hlsl";
            const string kSpriteLitPass = "Packages/com.gameboxinteractive.portal-render-pipeline/Editor/ShaderGraph/Includes/SpriteLitPass.hlsl";
            const string kSpriteNormalPass = "Packages/com.gameboxinteractive.portal-render-pipeline/Editor/ShaderGraph/Includes/SpriteNormalPass.hlsl";
            const string kSpriteForwardPass = "Packages/com.gameboxinteractive.portal-render-pipeline/Editor/ShaderGraph/Includes/SpriteForwardPass.hlsl";
