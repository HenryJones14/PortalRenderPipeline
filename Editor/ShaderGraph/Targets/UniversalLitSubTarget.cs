...
#region Includes
        ...
        {
            const string kShadows = "Packages/com.gameboxinteractive.portal-render-pipeline/ShaderLibrary/Shadows.hlsl";
            const string kMetaInput = "Packages/com.gameboxinteractive.portal-render-pipeline/ShaderLibrary/MetaInput.hlsl";
            const string kForwardPass = "Packages/com.gameboxinteractive.portal-render-pipeline/Editor/ShaderGraph/Includes/PBRForwardPass.hlsl";
            const string kGBuffer = "Packages/com.gameboxinteractive.portal-render-pipeline/ShaderLibrary/UnityGBuffer.hlsl";
            const string kPBRGBufferPass = "Packages/com.gameboxinteractive.portal-render-pipeline/Editor/ShaderGraph/Includes/PBRGBufferPass.hlsl";
            const string kLightingMetaPass = "Packages/com.gameboxinteractive.portal-render-pipeline/Editor/ShaderGraph/Includes/LightingMetaPass.hlsl";
            const string k2DPass = "Packages/com.gameboxinteractive.portal-render-pipeline/Editor/ShaderGraph/Includes/PBR2DPass.hlsl";
